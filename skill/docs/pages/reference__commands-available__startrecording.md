> For the complete documentation index, see [llms.txt](https://docs.maestro.dev/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.maestro.dev/reference/commands-available/startrecording.md).
...
* You must use the [`stopRecording`](/reference/commands-available/stoprecording.md) command to finalize the video file.
...
You need to use the [`stopRecording`](/reference/commands-available/stoprecording.md) command to instruct Maestro to stop recording the device screen.
...
Maestro writes this command's output into the `startRecording` folder of the Flow's artifact bundle. See [Layout of a Flow's artifact folder](/maestro-flows/workspace-management/test-reports-and-artifacts.md#layout-of-a-flows-artifact-folder).
...
* [stopRecording](/reference/commands-available/stoprecording.md)
...
```
GET https://docs.maestro.dev/reference/commands-available/startrecording.md?ask=<question>&goal=<endgoal>
```
