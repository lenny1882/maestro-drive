> For the complete documentation index, see [llms.txt](https://docs.maestro.dev/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.maestro.dev/maestro-cloud/ci-cd-integration/bitrise.md).
...
Any variable prefixed with `MAESTRO_` will be [added as environment variable](/maestro-flows/flow-control-and-logic/parameters-and-constants.md) for your run.
{% endhint %}
...
```
GET https://docs.maestro.dev/maestro-cloud/ci-cd-integration/bitrise.md?ask=<question>&goal=<endgoal>
```
