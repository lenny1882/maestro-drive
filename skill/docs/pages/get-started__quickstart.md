> For the complete documentation index, see [llms.txt](https://docs.maestro.dev/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.maestro.dev/get-started/quickstart.md).
...
{% hint style="info" %}
To learn more about the commands you can use to create tests, access the [Commands](https://docs.maestro.dev/reference/)page.
...
<i class="fa-hand-point-right">:hand-point-right:</i> **Access** [Run tests with Maestro Studio](/maestro-studio/run-tests-with-maestro-studio.md) **for more information.**
{% endhint %}
...
```
GET https://docs.maestro.dev/get-started/quickstart.md?ask=<question>&goal=<endgoal>
```
