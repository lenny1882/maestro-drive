> For the complete documentation index, see [llms.txt](https://docs.maestro.dev/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.maestro.dev/get-started/how-maestro-works.md).
...
* Check the [QuickStart](/get-started/quickstart.md) guide to learn how to install Maestro Studio and run your first test.
* Explore each of the available [Maestro solutions](/get-started/maestro-solutions.md).
...
```
GET https://docs.maestro.dev/get-started/how-maestro-works.md?ask=<question>&goal=<endgoal>
```
