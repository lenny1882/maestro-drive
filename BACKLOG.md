...
**Five items are open — 87, 90, 93, 97 and 100.** 99 and 101–106 were finished on
24 Sep and are in `BACKLOG-DONE.md`, with 50, which was reopened and closed the
same day. 87 is not gated; 90 waits on
...
word of MCP; 100 is gated on the setup
...
**85 is done, on 18 Sep, and is in `BACKLOG-DONE.md`.** It was the first item about setting the skill up
...
work in them is real and is filed as **91** and **92**, both done and in
`BACKLOG-DONE.md`. The commit
